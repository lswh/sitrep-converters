...
with open('DAMAGED_HOUSES_shp.csv', 'wb') as f:
     writer = csv.writer(f, quoting=csv.QUOTE_ALL)
     writer.writerow( ('SR_NO', 'TYPE', 'REGION', 'PROVINCE', 'MUNICIPALITY', 'TOTALLY DAMAGED', 'PARTIALLY DAMAGED', 'OVERALL TOTAL') )
...
with open('DAMAGED_HOUSES_web2py.csv', 'wb') as f:
     ...
     writer = csv.writer(f, quoting=csv.QUOTE_ALL)
     writer.writerow( ('Template', 'Series', 'Organisation', 'STD-WHO', 'STD-L0', 'STD-L1', 'STD-L2', 'STD-L3', 'STD-Lon', 'STD-Lat', 'STD-DATE', 'STD-TIME', 'DH1', 'DH2', 'DH3') )
